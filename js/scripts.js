...
for(var i = 0; i < about_tags.length; i++){
	about_tags[i].onclick = function(){
		...
		var selecionando = this.innerHTML;
		document.getElementById("box-text").innerHTML = aboutUs[selecionando];
	};
}
...
//API Key Google Maps: AIzaSyANGEllkql77UVKYeflW4zBXgOfdyJ44-U  
